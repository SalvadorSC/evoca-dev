    ...
    <section className="px-6 py-16 border-t border-[#1f1f1f]">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="font-display font-bold text-white text-3xl mb-3 text-balance">
            Simple pricing for every event
          </h2>
          <p className="font-sans text-[#888] text-base">
          ...
          {ORGANIZER_PLAN_IDS.map((planId, i) => {
            ...
            return (
              <div
                ...
                style={{
                  borderColor: featured ? "var(--accent)" : "#2a2a2a",
              ...
              >
                <div>
                  ...
                  <div className="mt-3 flex items-baseline gap-1">
                    <span className="font-display font-bold text-white text-3xl">{label.big}</span>
                    <span className="font-mono text-xs text-[#888]">{label.small}</span>
                  </div>
                  <p className="font-sans text-sm text-[#888] mt-2 leading-relaxed">{plan.description}</p>
                </div>

// ─────────────────────────────────────────────────────────────────────────────
// EVOCA — Terms of Service (canonical source)
//
// This is the single source of truth for the published /terms page. It was
// initially drafted with the `terms-of-service-generator` skill.
//
...
export const TERMS_LAST_UPDATED = "June 30, 2026"
export const TERMS_EFFECTIVE_DATE = "June 30, 2026"
...
These Terms of Service ("Terms") govern your access to and use of EVOCA (the "Service"), operated by EVOCA ("EVOCA", "we", "us", or "our"). The Service is available at [evoca.dev](https://evoca.dev) and provides real-time audience engagement for talks and events, including live reactions, Q&A, polls, and tools for organizers to manage schedules and speakers.
...
The current version of these Terms is always available at [evoca.dev/terms](https://evoca.dev/terms).
